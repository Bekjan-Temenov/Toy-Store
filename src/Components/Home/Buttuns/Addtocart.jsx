  ...
  return (
    <div ref={scope}>
      <button
        ...
        className="relative rounded-lg border-2  px-6 py-2 text-2xl text-white transition-colors bg-green-600 hover:bg-green-500"
      >
        <span className="sr-only">Add</span>
        <span className="block h-8 overflow-hidden" aria-hidden>
          {["A", "d", "d", "T", "o", "C" , "a" , "r" , "t"].map((letter, index) => (
            <span
              data-letter={letter}
